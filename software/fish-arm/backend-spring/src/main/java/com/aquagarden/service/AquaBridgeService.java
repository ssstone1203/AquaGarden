...
public class AquaBridgeService {
    ...
    public BridgeResponse task(String task) throws IOException, InterruptedException {
        return request("POST", "/api/task/" + task, null);
    }

    public BridgeResponse armHome() throws IOException, InterruptedException {
        return request("POST", "/api/arm/home", null);
    }

    public BridgeResponse armPose(Map<String, Object> payload) throws IOException, InterruptedException {
        String body = objectMapper.writeValueAsString(payload);
        return request("POST", "/api/arm/pose", body);
    }

    public BridgeResponse armGripper(Map<String, Object> payload) throws IOException, InterruptedException {
        String body = objectMapper.writeValueAsString(payload);
    ...
    public BridgeResponse railPosition(int position) throws IOException, InterruptedException {
    ...
    private BridgeResponse request(String method, String path, String jsonBody) throws IOException, InterruptedException {
