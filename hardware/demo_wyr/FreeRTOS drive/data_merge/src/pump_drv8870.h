/*******************************************************************************************************************//**
 * DRV8870 H-bridge pump control (RA6E2 + FSP).
 *
 * Wiring (must match RASC symbolic names, AG board):
 *   P206 (PUMP_VREF) -> DRV8870 VREF (GPIO out high ≈3.3 V; required with ISEN + R_sense for usable ITRIP)
 *   P302 (PUMP_IN1) -> DRV8870 IN1  (GPIO, logic 3.3 V)
 *   P301 (PUMP_IN2) -> DRV8870 IN2  (GPT4 GTIOC4B PWM)
 *
 * DRV8870 VM / GND / OUT1 / OUT2 go to 12 V supply and DC pump (see .c comment block).
 **********************************************************************************************************************/
