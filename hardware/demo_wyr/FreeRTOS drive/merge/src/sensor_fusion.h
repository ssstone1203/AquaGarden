...
/* Soil Watch variables kept compatible with the original single-test project. */
...
/* Pump control bridge variables for task interaction / debug. */
...
/* Multi-sensor linkage strategy parameters (runtime tunable). */
...
/* J-Scope-friendly variables (single scalar per signal). */
