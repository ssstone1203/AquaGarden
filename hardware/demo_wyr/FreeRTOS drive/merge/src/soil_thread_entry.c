...
{
    uint16_t min_raw = (SOIL_ADC_DRY_CAL_RAW < SOIL_ADC_WET_CAL_RAW) ? SOIL_ADC_DRY_CAL_RAW : SOIL_ADC_WET_CAL_RAW;
    uint16_t max_raw = (SOIL_ADC_DRY_CAL_RAW > SOIL_ADC_WET_CAL_RAW) ? SOIL_ADC_DRY_CAL_RAW : SOIL_ADC_WET_CAL_RAW;
