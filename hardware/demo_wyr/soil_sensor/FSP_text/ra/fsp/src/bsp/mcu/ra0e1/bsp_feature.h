...
#define BSP_FEATURE_ADC_D_CHANNELS_MASK                           (0x006000FFUL)    // Mask of available channels.
#define BSP_FEATURE_ADC_D_SCAN_MODE_CHANNELS_MASK                 (0x1FUL)          // Mask of channels available in scan mode.
...
#define BSP_FEATURE_ICU_IRQ_CHANNELS_MASK                         (0x3FUL)          // Mask of available IRQ control registers.
#define BSP_FEATURE_ICU_NMIER_MAX_INDEX                           (8UL)             // Maximum bit field index of valid fields of the NMIER register.
#define BSP_FEATURE_ICU_SBYEDCR_MASK                              (0x000003838C1404FFULL)   // A mask of valid bits for [SBYEDCR1:SBYEDCR0].
