...
gpt_instance_ctrl_t g_ultra_echo_timer_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_ultra_echo_timer_pwm_extend =
{
    .trough_ipl          = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_ultra_echo_timer_extend =
{
    .gtioca = { .output_enabled = false,
                .stop_level     = GPT_PIN_LEVEL_LOW
              },
    ...
    .capture_filter_gtiocb       = GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg                   = &g_ultra_echo_timer_pwm_extend,
#else
    .p_pwm_cfg                   = NULL,
#endif
#if 0
