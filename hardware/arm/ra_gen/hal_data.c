...
agt_instance_ctrl_t g_ultra_echo_timer_ctrl;
const agt_extended_cfg_t g_ultra_echo_timer_extend =
{
...
const timer_cfg_t g_ultra_echo_timer_cfg =
{
    .mode                = TIMER_MODE_PERIODIC,
    /* Actual period: 0.01048576 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x10000, .duty_cycle_counts = 0x8000, .source_div = (timer_source_div_t)3,
    .channel             = 0,
    .p_callback          = NULL,
    ...
    .p_context           = (void *) &NULL,
#endif
    .p_extend            = &g_ultra_echo_timer_extend,
...
const timer_instance_t g_ultra_echo_timer =
{
    .p_ctrl        = &g_ultra_echo_timer_ctrl,
    .p_cfg         = &g_ultra_echo_timer_cfg,
    .p_api         = &g_timer_on_agt
};
gpt_instance_ctrl_t g_rgb_timer_ctrl;
#if 0
...
#if 0
    .p_pwm_cfg                   = &g_rgb_timer_pwm_extend,
#else
    .p_pwm_cfg                   = NULL,
#endif
#if 0
...
const timer_cfg_t g_rgb_timer_cfg =
{
    .mode                = TIMER_MODE_PERIODIC,
...
/* Instance structure to use this module. */
const timer_instance_t g_rgb_timer =
{
    .p_ctrl        = &g_rgb_timer_ctrl,
    .p_cfg         = &g_rgb_timer_cfg,
    .p_api         = &g_timer_on_gpt
};
sci_uart_instance_ctrl_t     g_com_uart_ctrl;

            baud_setting_t               g_com_uart_baud_setting =
            {
            ...
            const sci_uart_extended_cfg_t g_com_uart_cfg_extend =
            {
                .clock                = SCI_UART_CLOCK_INT,
                .rx_edge_start          = SCI_UART_START_BIT_FALLING_EDGE,
                .noise_cancel         = SCI_UART_NOISE_CANCELLATION_DISABLE,
                .rx_fifo_trigger        = SCI_UART_RX_FIFO_TRIGGER_MAX,
                .p_baud_setting         = &g_com_uart_baud_setting,
            ...
            const uart_cfg_t g_com_uart_cfg =
            {
                .channel             = 2,
                ...
                .p_callback          = NULL,
                .p_context           = NULL,
                .p_extend            = &g_com_uart_cfg_extend,
...
/* Instance structure to use this module. */
const uart_instance_t g_com_uart =
{
    .p_ctrl        = &g_com_uart_ctrl,
    .p_cfg         = &g_com_uart_cfg,
    .p_api         = &g_uart_on_sci
};
#include "r_sci_i2c_cfg.h"
sci_i2c_instance_ctrl_t g_stepper_i2c_ctrl;
const sci_i2c_extended_cfg_t g_stepper_i2c_cfg_extend =
{
...
const i2c_master_cfg_t g_stepper_i2c_cfg =
{
    .channel             = 3,
...
#undef RA_NOT_DEFINED
    ...
    .p_extend            = &g_stepper_i2c_cfg_extend,
};
/* Instance structure to use this module. */
const i2c_master_instance_t g_stepper_i2c =
{
    .p_ctrl        = &g_stepper_i2c_ctrl,
    .p_cfg         = &g_stepper_i2c_cfg,
    .p_api         = &g_i2c_master_on_sci
};
sci_uart_instance_ctrl_t     g_serial_servo_uart_ctrl;
            ...
            /** UART extended configuration for UARTonSCI HAL driver */
            const sci_uart_extended_cfg_t g_serial_servo_uart_cfg_extend =
            {
                .clock                = SCI_UART_CLOCK_INT,
                .rx_edge_start          = SCI_UART_START_BIT_FALLING_EDGE,
                .noise_cancel         = SCI_UART_NOISE_CANCELLATION_DISABLE,
                .rx_fifo_trigger        = SCI_UART_RX_FIFO_TRIGGER_MAX,
                .p_baud_setting         = &g_serial_servo_uart_baud_setting,
                .flow_control           = SCI_UART_FLOW_CONTROL_RTS,
                #if 0xFF != 0xFF
                .flow_control_pin       = BSP_IO_PORT_FF_PIN_0xFF,
                #else
            ...
            const uart_cfg_t g_serial_servo_uart_cfg =
            {
                ...
                .p_callback          = NULL,
                .p_context           = NULL,
                .p_extend            = &g_serial_servo_uart_cfg_extend,
#define RA_NOT_DEFINED (1)
#if (RA_NOT_DEFINED == RA_NOT_DEFINED)
                .p_transfer_tx       = NULL,
#else
...
/* Instance structure to use this module. */
const uart_instance_t g_serial_servo_uart =
{
    .p_ctrl        = &g_serial_servo_uart_ctrl,
    .p_cfg         = &g_serial_servo_uart_cfg,
    .p_api         = &g_uart_on_sci
};
