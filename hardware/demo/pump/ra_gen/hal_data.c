...
/* Actual period: 0.00004 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xfa0,
  .duty_cycle_counts = 0x7d0, .source_div = (timer_source_div_t) 0, .channel = 2, .p_callback = NULL,
...
{ .p_ctrl = &g_pump_timer_ctrl, .p_cfg = &g_pump_timer_cfg, .p_api = &g_timer_on_gpt };
