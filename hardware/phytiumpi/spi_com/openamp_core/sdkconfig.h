...
#define CONFIG_TARGET_NAME "openamp_spi_core0"
/* end of Baremetal Configuration */
/* CONFIG_OPENAMP_TRACE_DEBUG is not set */
#define CONFIG_AQUA_RA6E2_PREP_US_OVERRIDE 5000
...
/* CONFIG_USE_ACPICA is not set */
/* CONFIG_USE_CJSON is not set */
/* CONFIG_USE_CODEC is not set */
/* CONFIG_USE_TENSORFLOW_LITE_MICRO is not set */
